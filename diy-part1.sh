...
echo 'src-git autoreboot https://github.com/akihara-sam/luci-app-autoreboot.git' >>feeds.conf.default
# echo 'src-git luci_app_autoreboot https://github.com/akihara-sam/luci-app-autoreboot.git' >>feeds.conf.default
